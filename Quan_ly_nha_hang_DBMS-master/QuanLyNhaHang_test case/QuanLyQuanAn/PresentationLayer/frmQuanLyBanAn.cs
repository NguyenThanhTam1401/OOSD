...
namespace QuanLyQuanAn
{
    public partial class frmQuanLyBanAn : Form
    {
        ...
        public static List<cOrdered> lsMenu;
        ...
        void ShowBill(int IDtable)
        {
            ...
            TotalPrice = 0;
            lsMenu = food.GetListOrdered(IDtable);
            foreach (cOrdered item in lsMenu)
            {
        ...
        private void ChuyenBan()
        {
            ...
            if (!bill.ChuyenBan(IDTABLE, idtb, frmQuanLy.Account.User, ref error))
                showErr();
